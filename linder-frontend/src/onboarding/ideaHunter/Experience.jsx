  ...
  return (
    <div className="p-5">
      ...
      <form className="w-full flex flex-col items-center gap-4">
        ...
        <button onClick={(e)=>e.preventDefault()} className="w-[30%] mr-auto px-2 py-2.5 bg-blue-600 text-white shadow-md border-0 text-base font-semibold rounded-lg hover:bg-blue-400 transition-all duration-300">
          + Add Skill
        </button>
      </form>
